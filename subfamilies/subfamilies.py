#!/home/victor/anaconda3/bin/python
# coding: utf-8
...
if __name__ == "__main__":
    ...
    mmseqs_db_cmd = '/home/linuxbrew/.linuxbrew/bin/mmseqs createdb '+fasta_filename+' '+db_filename+' >'+log_filename
    ...
    mmseqs_cluster_cmd = '/home/linuxbrew/.linuxbrew/bin/mmseqs cluster '+db_filename+' '+cluster_filename+' '+tmp_directory+' '+'--threads '+str(args.cpu)+' -s 7.5 -c '+str(args.coverage)+' --cov-mode 0 --max-seqs 5000 -e 0.001 --cluster-mode 0'+' >'+log_filename
    ...
    mmseqs_createtsv_cmd = '/home/linuxbrew/.linuxbrew/bin/mmseqs createtsv '+db_filename+' '+db_filename+' '+cluster_filename+' '+tsv_filename+' >'+log_filename
    ...
    mmseqs_result2msa_cmd = '/home/linuxbrew/.linuxbrew/bin/mmseqs result2msa '+db_filename+' '+db_filename+' '+cluster_filename+' '+msa_filename+' --diff 100 --threads '+str(args.cpu)+' >'+log_filename
